...
'/// PROC�DURE  : formate la feuille excel en plateau de jeu par defaut
'/// PARAM�TRE  : Aucun
'/// RETOUR     : Aucun (sub)
Public Sub FormatBoard()
    ...
    For Each cell In Range("B2:I9")
        ...
        If (cell.Column + cell.Row) Mod 2 = 0 Then
            'color la cellule en blanc cass�
    ...
    'On modifie les parametres de toutes les cellules comprises sur l'air de jeu et a cot�
    With Range("A1:N11")
...
'/// PROC�DURE  : Initialise le plateau de jeu en positionnant les pions sur leur valeur par defaut
'/// PARAM�TRE  : Aucun
'/// RETOUR     : Aucun (sub)
